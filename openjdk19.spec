...
Obsoletes:	jdk
Obsoletes:	kaffe
Obsoletes:	openjdk19-jdk < 19.0.2-2
Obsoletes:	oracle-java7
...
Provides:	jdk(%{name})
Obsoletes:	openjdk19-jdk-base < 19.0.2-2
...
Obsoletes:	jre
Obsoletes:	jsse
Obsoletes:	openjdk19-jre < 19.0.2-2
Obsoletes:	oracle-java7-jre
...
Provides:	jre(%{name})
Obsoletes:	openjdk19-jre-base < 19.0.2-2
...
Obsoletes:	openjdk19-jre-base-X11 < 19.0.2-2
...
Obsoletes:	openjdk19-jre-base-freetype < 19.0.2-2
...
Obsoletes:	jar
Obsoletes:	openjdk19-jar < 19.0.2-2
